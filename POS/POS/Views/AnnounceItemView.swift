...
#Preview {
    AnnounceItemView(item: .init(id: "123", title: "AnnounceTitle", createDate: Date().timeIntervalSince1970, content: "contenttttttt", creator: "tNcfb0V8ergVGyPfyuUkRQWlnoW2"))
}
